import 'package:fitness_99/controllers/group_screen_controller/my_group_categories_controller.dart';
...
class MyGroupCategoriesScreen extends StatelessWidget {
  final group_id;
  MyGroupCategoriesScreen({Key? key, required this.group_id}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(MyGroupCategoriesController(group_id: group_id));
                    ...
                    children: [
                      ...
                      controller.categoriesApiList.isNotEmpty
                          ? Container(
                              ...
                              child: GetBuilder<MyGroupCategoriesController>(
